...
{
    uint8 configuration[] = {0x02}; // enable indications
    ble_cmd_attclient_attribute_write(connection_handle, thermometer_handle_configuration, 1, &configuration);
}
...
void ble_evt_connection_disconnected(const struct ble_msg_connection_disconnected_evt_t *msg)
{
    ...
    ble_cmd_gap_connect_direct(&connect_addr, gap_address_type_public, 40, 40, 100,0);
}
